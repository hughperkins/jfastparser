...
public class TestParser {
	...
	public void testNewline() {
		...
		assertThat(parser.eatNewline(), is(true));
		assertThat(parser.eatInt(), is(456));
		assertThat(parser.eatNewline(), is(false));
		parser.eatWhitespace();
		assertThat(parser.eatDouble(), is(12.3d));
		assertThat(parser.eatNewline(), is(true));
		assertThat(parser.more(), is(false));
	}
}
